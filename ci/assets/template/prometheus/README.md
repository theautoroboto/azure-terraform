...
```
credhub login --client-name=credhubadmin --client-secret=CHANGE_ME -s director.cloudfoundry.domain.com:8844 --skip-tls-validation
credhub find -n uaa/admin_client_credentials
uaac target uaa.sys.xxx.domain.com --skip-ssl-validation
